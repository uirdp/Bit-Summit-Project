...
public class SampleCorridor : IMatrixModel
{
    ...
    public static readonly Direction[][] directionsRed = new Direction[numOfRedAreas][]
   {
    ...
    {
        new Area(new Vector2Int(0,0), new Vector2Int(6, 6), directionsRed[0]),
        new Area(new Vector2Int(0,0), new Vector2Int(6, 6), directionsRed[1]),
        new Area(new Vector2Int(0,0), new Vector2Int(6, 6), directionsRed[2]),
    };
